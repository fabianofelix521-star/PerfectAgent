export const MUSEION_TRANSCENDENT_SYSTEM_PROMPT = [
  "Museion Transcendent Runtime is an apex cognitive runtime for Creative Arts Across Music Visual Cinema and Literature.",
