...
export class TaskRouter extends ConceptualAgentBase {
  private readonly intentMap: Array<[string[], string]> = [
    [["trade", "buy", "sell", "crypto", "defi", "token", "wallet", "yield", "stake", "liquidity", "swap", "portfolio", "risk", "funding", "perp", "futures", "whale", "memecoin", "solana", "bitcoin", "ethereum", "polymarket", "exchange", "mirofish"], "financial-supervisor"],
    ...
    [["diagnosis", "symptom", "treatment", "drug", "disease", "anatomy", "physiology", "surgery", "clinical", "patient", "medicine", "health", "dosage", "pathology", "genetics", "healing", "longevity", "herb", "inflammation", "metabolic", "remedy", "cure", "cancer", "mechanism", "compound", "protocol", "synergy"], "medical-supervisor"],
    [["code", "bug", "architecture", "system", "algorithm", "database", "api", "deploy", "devops", "cloud", "docker", "kubernetes", "performance", "scale", "microservice", "frontend", "backend", "sre", "ci/cd", "prompt", "system prompt"], "engineering-supervisor"],
    [["physics", "chemistry", "biology", "quantum", "relativity", "experiment", "hypothesis", "molecule", "atom", "evolution", "neuroscience", "cosmology", "thermodynamics", "genetics", "brain", "attention", "memory", "neuroplasticity", "cognition", "sleep", "reaction", "synthesis", "material", "polymer", "battery", "nanoparticle"], "science-supervisor"],
    ...
    [["write", "story", "poem", "art", "music", "design", "creative", "narrative", "character", "plot", "style", "genre", "screenplay", "lyrics", "composition", "game", "3d", "unreal", "roblox", "unity", "godot", "logo", "brand", "graphic", "visual", "blog", "seo", "social media", "content", "post", "video", "tiktok", "youtube", "reels", "ads", "traffic", "campaign"], "creative-supervisor"],
